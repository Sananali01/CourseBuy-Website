...
const courses = [
    ...
    },
    {
        ...
        category: "python",
        image: course_images.python_3,
        course_name: "Python Django Web Framework - Full Course for Beginners",
        description: "Learn Django, the #1 Python web framework. Build fully functional web applications from scratch.",
        rating_count: 1500,
        rating_star: 4.5,
        students: 25000,
        creator: "Nick Walter",
    ...
    },
    {
        ...
        category: "python",
        image: course_images.python_2,
        course_name: "Python GUI Programming using Tkinter and Python 3",
        description: "Learn Python GUI programming using Tkinter to create desktop applications with Python.",
        rating_count: 800,
        rating_star: 4.1,
        students: 12000,
        creator: "John Elder",
        ...
        what_you_will_learn: [
            "Build Python GUI applications",
            "Create interactive user interfaces",
            "Understand event-driven programming",
            "Work with different Tkinter widgets"
        ],
        content: [
    ...
    },
    {
        ...
        what_you_will_learn: [
            ...
            "Implement 10+ Machine Learning Models",
            "Understand Data Preprocessing, Visualization & more",
            "Supervised & Unsupervised Learning, etc."
        ],
        content: [
            "Data Preprocessing",
            "Regression: Simple Linear Regression, Multiple Linear Regression, etc.",
            "Classification: Logistic Regression, K-NN, SVM, Kernel SVM, etc.",
